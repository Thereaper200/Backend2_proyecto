        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $txtSupervisor; ?>" name="txtSupervisor" id="txtSupervisor" placeholder="Lider" autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="txtNombre">Nombre:</label>
                    <input type="text" class="form-control" value="<?php echo $txtPedido; ?>" name="txtPedido" id="txtPedido" placeholder="Nombre" autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="txtApellido">Apellido:</label>
                    <input type="text" class="form-control" value="<?php echo $txtPedido; ?>" name="txtPedido" id="txtPedido" placeholder="Apellido" autocomplete="off">
                </div>

                
                <div class="form-group">
                    <label for="intEmpleado">No. de Empleado:</label>
                    <input type="text" class="form-control" value="<?php echo $txtComentarios; ?>" name="txtComentarios" id="txtComentarios" placeholder="No. De Empleado" autocomplete="off">
                </div>
